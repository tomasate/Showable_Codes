...
cols = pd.Index(['missinget_met', 'missinget_eta', 'missinget_phi', 'jet_pt0', 'jet_pt1',
                  'jet_pt2', 'jet_pt3', 'jet_eta0', 'jet_eta1', 'jet_eta2', 'jet_eta3',
                  'jet_phi0', 'jet_phi1', 'jet_phi2', 'jet_phi3', 'jet_mass0',
                  'jet_mass1', 'jet_mass2', 'jet_mass3', 'jet_tautag0', 'jet_tautag1',
                  'jet_tautag2', 'jet_tautag3', 'jet_btag0', 'jet_btag1', 'jet_btag2',
                  'jet_btag3', 'jet_size', 'n_tau', 'n_b'])